...
## 📂 Struktur Repository
Berikut adalah daftar tugas yang telah dan akan dikerjakan:

| Folder | Project Name | Status | Deskripsi |
| :--- | :--- | :--- | :--- |
| `📂 tugas1-calculator` | **Calculator** | ✅ Done | Program Kalkulator sederhana memakai OOP, fitur kalkulator (+, -, *, /). Program juga menerapkan aturan presedensi, yaitu melakuan perhitungan matematika dengan mendahulukan operasi perkalian dan pembagian urut dari kiri ke kanan, lalu kemudian operasi penjumlahan dan pengurangan urut dari kiri ke kanan juga. |
| `📂 tugas2-future` | *TBA* | ⏳ Pending | - |
| `📂 tugas3-future` | *TBA* | ⏳ Pending | - |
...
[![My Skills](https://skillicons.dev/icons?i=kotlin,androidstudio,idea,git)](https://kotlinlang.org/)
...
1. Clone repository ini:
   ```bash
   git clone [https://github.com/fitria-lm/mobile-app-kuliah.git](https://github.com/fitria-lm/mobile-app-kuliah.git)
2. Buka folder tugas yang diinginkan (misal `tugas1-calculator`).
3. Jalankan melalui IDE **IntelliJ IDEA** atau **Android Studio**.
